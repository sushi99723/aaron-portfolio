...
export function Opening(){
 ...
 return <section id="home" ref={root} className="opening"><div className="opening-stage">
  ...
  {['art/aaron-hero.png','art/aaron-about.png','art/aaron-tools.png'].map((src,i)=><div key={src} className={`opening-scene scene-${i} ${active===i?'is-active':''}`} aria-hidden={active!==i}><img src={src} alt="" fetchPriority={i===0?'high':'auto'}/></div>)}
