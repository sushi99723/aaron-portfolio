...
export function SofaHero(){
 ...
 <div className="sofa-bg" style={{backgroundImage:`url(${import.meta.env.BASE_URL}art/aaron-sofa-hero.png)`}}>{intro!=='clear'&&<RippleBackground/>}</div><div className="sofa-shade"/>
