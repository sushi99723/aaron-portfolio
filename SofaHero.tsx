...
const loadLockerHero=()=>import('./LockerHero').then(module=>({default:module.LockerHero}));
const LockerHero=lazy(loadLockerHero);
...
export function SofaHero(){
 ...
 <div className="sofa-bg" style={{backgroundImage:`url(${import.meta.env.BASE_URL}art/${mobile?'aaron-sofa-hero-mobile.webp':'aaron-sofa-hero.webp'})`}}/><div className="sofa-shade"/>
